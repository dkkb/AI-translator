...
function DETECT(myTransText){
 ...
 if(BOXCONTENT == myTransText){ 
	...
	if(GEBI('SLlocpl').checked != true){
		...
		if(GEBI("SL_langDst").value==SL_DETECT) SL_Flip_Langs(SL_DETECT);
		if(SL_WRONGLANGUAGEDETECTED==0)	GEBI("SL_detect").innerHTML = FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extDetected')+" "+DetLangName;
	}
 }	
...
function LTR_RTL(ctrl){
	...
	GEBI(ctrl).dir="ltr";
	if(myLang=="ar" || myLang=="iw" || myLang=="fa" || myLang=="ur" || myLang=="yi" || myLang=="ps" || myLang=="sd" || myLang=="ckb") GEBI(ctrl).dir="rtl";
}

function MORE_LTR_RTL(){
 	var myLang = DetLang; 	
	GEBI("SL_source").dir="ltr";
	if(myLang=="ar" || myLang=="iw" || myLang=="fa" || myLang=="ur" || myLang=="yi" || myLang=="ps" || myLang=="sd" || myLang=="ckb") GEBI("SL_source").dir="rtl";

	myLang = GEBI("SL_langDst").value;
	GEBI("SL_target").dir="ltr";
	if(myLang=="ar" || myLang=="iw" || myLang=="fa" || myLang=="ur" || myLang=="yi" || myLang=="ps" || myLang=="sd" || myLang=="ckb") GEBI("SL_target").dir="rtl";

	myLang = DetLang;
	GEBI("SL_back").dir="ltr";
	if(myLang=="ar" || myLang=="iw" || myLang=="fa" || myLang=="ur" || myLang=="yi" || myLang=="ps" || myLang=="sd" || myLang=="ckb") GEBI("SL_back").dir="rtl";
}
...
if(CLOSER==0 || localStorage["SL_GotIt"]!="1"){
 ...
 if((box=="SRC" && GEBI('SLlocpl').checked==false) || (box=="SRC" && GEBI("SL_langSrc").value=="auto")){
  ...
  setTimeout(function(){
   if(SL_to=="") SL_to = GEBI("SL_langSrc").value;
