...
function SL_LTR_RTL(dir){
 var TheClass="SL_ltr";
 if(dir=="ar" || dir=="iw" || dir=="fa" || dir=="ur" || dir=="yi" || dir=="ps" || dir=="sd" || dir=="ckb") var TheClass="SL_rtl";
 return(TheClass);
}
...
function SL_ALIGNER(SRC,L1,L2){
 ...
 if(L2=="ar" || L2=="iw" || L2=="fa" || L2=="ur" || L2=="yi" || L2=="ps" || L2=="sd" || L2=="ckb"){
 ...
 if(L1=="ar" || L1=="iw" || L1=="fa" || L1=="ur" || L1=="yi" || L1=="ps" || L1=="sd" || L1=="ckb")   OUT = OUT.replace(/ id=_AR>/g, ' id=_AR style="text-align:right">');
