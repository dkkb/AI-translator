...
function LOCALIZATION(){	
	GEBI('SL_menu_h1').appendChild(document.createTextNode(FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extOptions')));
	GEBI('SL_menu_PP').title=FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extContribution_ttl');
	GEBI('SL_m5').appendChild(document.createTextNode(FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extHistory_ttl')));
	GEBI('SL_m9').appendChild(document.createTextNode(FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extHotKeys')));
	GEBI('SL_m6').appendChild(document.createTextNode(FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extHelp')));
	GEBI('SL_m7').appendChild(document.createTextNode(FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extFeedback')));
	var Ab = "© ImTranslator";
        if(FExtension.GET_localStorage("SL_LOCALIZATION")=="en") Ab = "About";
        GEBI('SL_m8').appendChild(document.createTextNode(Ab));
	GEBI('SL_m10').appendChild(document.createTextNode(FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extADV')));
	CONTRIBUTION();
}
