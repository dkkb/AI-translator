...
(function(){GEBI("SRV4").addEventListener("keyup",function(){ if(GEBI("SRV4").value=="")GEBI('SRV4').value=FExtension.GET_localStorage("SL_HK_it2");},!1); } )();

(function(){GEBI("SRV12").addEventListener("click",function(){ SL_ACTIVE = GEBI("SRV12"); SL_TMP=SL_ACTIVE.value; SL_ACTIVE.focus();SL_ACTIVE.select();SL_KBD(1);},!1); } )();
(function(){GEBI("SRV12").addEventListener("mouseout",function(){ SL_KBD(0);},!1); } )();
(function(){GEBI("SRV12").addEventListener("keyup",function(){ if(GEBI("SRV12").value=="")GEBI('SRV12').value=FExtension.GET_localStorage("SL_change_lang_HK_it");},!1); } )();
...
(function(){GEBI("SL_FK_box12").addEventListener("click",function(){ SL_HIDE_HK("SL_FK_box12","SL_HIDE12");VERIFY();},!1); } )();
...
function VERIFY(ob){
 ...
 if(GEBI("SRV12").value==""){
	GEBI('SRV12').value=FExtension.GET_localStorage("SL_change_lang_HKbox_it");
	GEBI('SL_kbd').innerText = FExtension.element(FExtension.GET_localStorage("SL_LOCALIZATION"),'extUseHK');
 }	
 ...
 ARR[2] = GEBI("SL_FK_box12").checked+"|"+GEBI("SRV12").value;
 GEBI("SRV3").style.background='#FFF';
 GEBI("SRV4").style.background='#FFF';
 GEBI("SRV12").style.background='#FFF';
 if(ARR[0]==ARR[1]){GEBI("SRV3").style.background='#F0D3D1'; GEBI("SRV4").style.background='#F0D3D1';}
 if(ARR[1]==ARR[2]){GEBI("SRV4").style.background='#F0D3D1'; GEBI("SRV12").style.background='#F0D3D1';}
 if(ARR[0]==ARR[2]){GEBI("SRV3").style.background='#F0D3D1'; GEBI("SRV12").style.background='#F0D3D1';}
